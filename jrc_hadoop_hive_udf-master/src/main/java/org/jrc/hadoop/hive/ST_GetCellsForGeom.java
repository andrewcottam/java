...
import static org.jrc.CellCalculator.MAX_LAT;
import static org.jrc.CellCalculator.MAX_LON;
import static org.jrc.CellCalculator.MIN_LAT;
import static org.jrc.CellCalculator.MIN_LON;

/**
 * Calculates all the cell intersecting with a geometry at a certain cell size.
 */
public class ST_GetCellsForGeom extends GenericUDTF {

  private static final SpatialReference SPATIAL_REFERENCE = SpatialReference.create(4326);
  private static final Log LOG = LogFactory.getLog(ST_GetCellsForGeom.class);
